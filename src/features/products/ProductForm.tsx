...
const productSchema = (productType: ProductType) => z.object({
  ...
  purchasePrice: productType === 'RETAIL' ? positive('Purchase price') : z.string().optional(),
